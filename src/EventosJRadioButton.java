 ...
 * @author Javier
 */
public class EventosJRadioButton extends javax.swing.JDialog {

    /**
     * Creates new form EventosJRadioBox
     */
    public EventosJRadioButton(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EventosJRadioButton.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EventosJRadioButton dialog = new EventosJRadioButton(new javax.swing.JFrame(), true);
